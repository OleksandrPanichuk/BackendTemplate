...
const {
  ...
  getRuntime,
  createParam,
} = __webpack_require__(/*! ./runtime/library.js */ "./generated/prisma/runtime/library.js")
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Sublime\\web\\backend\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Sublime\\web\\backend\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
...
const { warnEnvConflicts } = __webpack_require__(/*! ./runtime/library.js */ "./generated/prisma/runtime/library.js")
...
`)}var yl=O(Os());function bl({title:e,user:r="prisma",repo:t="prisma",template:n="bug_report.yml",body:i}){return(0,yl.default)({user:r,repo:t,template:n,title:e,body:i})}function El({version:e,binaryTarget:r,title:t,description:n,engineVersion:i,database:o,query:s}){let a=Bo(6e3-(s?.length??0)),l=hl(wr(a)),u=n?`# Description
\`\`\`
${n}
...
/***/ "./libs/hashing/src/hashing.module.ts":
/*!********************************************!*\
  !*** ./libs/hashing/src/hashing.module.ts ***!
  \********************************************/
...
const hashing_service_1 = __webpack_require__(/*! ./hashing.service */ "./libs/hashing/src/hashing.service.ts");
...
/***/ "./libs/hashing/src/hashing.service.ts":
/*!*********************************************!*\
  !*** ./libs/hashing/src/hashing.service.ts ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let HashingService = class HashingService {
    async hash(data, options) {
        return (0, argon2_1.hash)(data, options);
    }
    async verify(hashedData, plain) {
        return (0, argon2_1.verify)(hashedData, plain);
    }
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./hashing.module */ "./libs/hashing/src/hashing.module.ts"), exports);
__exportStar(__webpack_require__(/*! ./hashing.service */ "./libs/hashing/src/hashing.service.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./logger.config */ "./libs/logger/src/logger.config.ts"), exports);
...
const developmentFormat = winston.format.combine(winston.format.timestamp({ format: 'YYYY-MM-DD HH:mm:ss' }), winston.format.colorize({ all: true }), winston.format.printf((info) => {
...
const logger_config_1 = __webpack_require__(/*! ./logger.config */ "./libs/logger/src/logger.config.ts");
    ...
    (0, common_1.Module)({
        imports: [
            nest_winston_1.WinstonModule.forRoot({
                instance: (0, winston_1.createLogger)((0, logger_config_1.getLoggerConfig)()),
            }),
        ],
        providers: [
            {
                ...
                useFactory: () => {
                    const logger = (0, winston_1.createLogger)((0, logger_config_1.getLoggerConfig)());
                    return new logger_service_1.LoggerService(logger);
                },
            },
        ],
...
__exportStar(__webpack_require__(/*! ./mailer.service */ "./libs/mailer/src/mailer.service.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TEMPLATE_PATHS = exports.TEMPLATES_DIR = exports.TEMPLATES = void 0;
const path = __webpack_require__(/*! path */ "path");
var TEMPLATES;
(function (TEMPLATES) {
    TEMPLATES["RESET_PASSWORD"] = "RESET_PASSWORD";
    TEMPLATES["WELCOME"] = "WELCOME";
    TEMPLATES["EMAIL_VERIFICATION"] = "EMAIL_VERIFICATION";
})(TEMPLATES || (exports.TEMPLATES = TEMPLATES = {}));
exports.TEMPLATES_DIR = path.join(process.cwd(), 'templates');
exports.TEMPLATE_PATHS = {
    RESET_PASSWORD: {
        subject: path.join(exports.TEMPLATES_DIR, 'reset-password', 'subject.hbs'),
        html: path.join(exports.TEMPLATES_DIR, 'reset-password', 'html.hbs'),
        text: path.join(exports.TEMPLATES_DIR, 'reset-password', 'text.hbs'),
    },
    WELCOME: {
        subject: path.join(exports.TEMPLATES_DIR, 'welcome', 'subject.hbs'),
        html: path.join(exports.TEMPLATES_DIR, 'welcome', 'html.hbs'),
        text: path.join(exports.TEMPLATES_DIR, 'welcome', 'text.hbs'),
    },
    EMAIL_VERIFICATION: {
        subject: path.join(exports.TEMPLATES_DIR, 'email-verification', 'subject.hbs'),
        html: path.join(exports.TEMPLATES_DIR, 'email-verification', 'html.hbs'),
        text: path.join(exports.TEMPLATES_DIR, 'email-verification', 'text.hbs'),
    },
};
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const mailer_service_1 = __webpack_require__(/*! ./mailer.service */ "./libs/mailer/src/mailer.service.ts");
...
let MailerService = MailerService_1 = class MailerService {
    ...
    constructor(config) {
        this.config = config;
        this.defaultFrom = this.config.get(config_1.Env.MAIL_FROM);
        this.transporter = (0, nodemailer_1.createTransport)({
            host: config.get(config_1.Env.MAIL_HOST),
            port: parseInt(config.get(config_1.Env.MAIL_PORT)),
            secure: true,
            auth: {
                user: config.get(config_1.Env.MAIL_USER),
                pass: config.get(config_1.Env.MAIL_PASSWORD),
            },
    ...
    async sendWelcomeEmail(email, userName, dashboardLink) {
        await this.sendEmail({
            to: email,
            template: mailer_constants_1.TEMPLATES.WELCOME,
            variables: {
                userName,
                dashboardLink,
            },
    ...
    async sendPasswordResetEmail(email, resetLink, userName, expiresIn = 15) {
        await this.sendEmail({
            to: email,
            template: mailer_constants_1.TEMPLATES.RESET_PASSWORD,
            variables: {
                userName,
                resetLink,
                expiresIn,
    ...
    async sendEmailVerification(email, userName, verificationCode, expiresIn = 30) {
        await this.sendEmail({
            to: email,
            template: mailer_constants_1.TEMPLATES.EMAIL_VERIFICATION,
            variables: {
                userName,
                verificationCode,
                expiresIn,
    ...
    async sendWithRetry(mailOptions, recipients, template, attempt = 1) {
        try {
            const info = await this.transporter.sendMail(mailOptions);
            this.logger.log(`Email sent successfully to ${recipients.join(', ')} using template ${template} (messageId: ${info.messageId})`);
        }
        catch (error) {
            const errorMessage = error instanceof Error ? error.message : String(error);
            if (attempt < this.MAX_RETRIES) {
                const delayMs = this.RETRY_DELAY_MS * attempt;
                this.logger.warn(`Attempt ${attempt}/${this.MAX_RETRIES} to send email failed: ${errorMessage}. Retrying in ${delayMs}ms...`);
                await this.delay(delayMs);
                return this.sendWithRetry(mailOptions, recipients, template, attempt + 1);
            }
            this.logger.error(`Failed to send email to ${recipients.join(', ')} using template ${template} after ${attempt} attempts: ${errorMessage}`, error instanceof Error ? error.stack : undefined);
            throw error;
        }
    }
    delay(ms) {
    ...
    async loadTemplates() {
        const templateKeys = Object.keys(mailer_constants_1.TEMPLATE_PATHS);
        for (const templateKey of templateKeys) {
            try {
                const paths = mailer_constants_1.TEMPLATE_PATHS[templateKey];
    ...
    async reloadTemplate(template) {
        const paths = mailer_constants_1.TEMPLATE_PATHS[template];
        if (!paths) {
    ...
    renderTemplate(template, variables) {
        ...
        const templateVariables = {
            appName: this.config.get(config_1.Env.APP_NAME) || 'Our App',
            currentYear: new Date().getFullYear(),
            supportEmail: this.config.get(config_1.Env.SUPPORT_EMAIL) || 'support@example.com',
            ...variables,
        };
        try {
            return {
    ...
    getAvailableTemplates() {
        return Object.values(mailer_constants_1.TEMPLATES);
    }
...
let PrismaService = PrismaService_1 = class PrismaService extends generated_1.PrismaClient {
    config;
...
let RedisService = RedisService_1 = class RedisService extends ioredis_1.default {
    ...
    constructor(configService) {
        const redisUrl = configService.get(config_2.Env.REDIS_URL);
        super(redisUrl);
...
const setup_1 = __webpack_require__(/*! @sentry/nestjs/setup */ "@sentry/nestjs/setup");
    ...
    (0, common_1.Module)({
        imports: [
            config_2.ConfigModule.forRoot({
                isGlobal: true,
                envFilePath: '.env',
                validate: (config) => config_1.envSchema.parse(config),
            }),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.STRATEGIES = exports.PASSWORD_CONFIG = void 0;
...
(function (STRATEGIES) {
    ...
    STRATEGIES["GITHUB"] = "github";
    STRATEGIES["LOCAL"] = "local";
...
const auth_types_1 = __webpack_require__(/*! @/auth/auth.types */ "./src/auth/auth.types.ts");
const dto_1 = __webpack_require__(/*! @/auth/dto */ "./src/auth/dto/index.ts");
...
let AuthController = AuthController_1 = class AuthController {
    ...
    async signIn(req, session) {
        ...
        if (user.requires2FA) {
            ...
            return {
                requires2FA: true,
                userId: user.id,
                message: 'Two-factor authentication required. Please verify using /auth/verify-2fa',
            };
        }
        await (0, session_utils_1.updateSession)(session, {
            passport: { user: user.id, verified: user.emailVerified },
    ...
    async signOut(session) {
        try {
            await (0, session_utils_1.destroySession)(session);
        }
        catch (err) {
    ...
    async googleCallback(req, session, res) {
        ...
        return res.redirect(this.config.get(config_1.Env.FRONTEND_URL));
    }
    signInGithub() { }
    ...
    async verify2FA(dto, session) {
        ...
        if (Date.now() - pending2FA.timestamp > fiveMinutes) {
            ...
            throw new Error('2FA verification session expired. Please sign in again.');
        }
        const user = await this.authService.verify2FA(pending2FA.userId, dto.method, dto.code);
        delete session.pending2FA;
        await (0, session_utils_1.updateSession)(session, {
            passport: { user: user.id, verified: user.emailVerified },
        });
...
__decorate([
    ...
    __metadata("design:paramtypes", [typeof (_c = typeof dto_1.SignUpInput !== "undefined" && dto_1.SignUpInput) === "function" ? _c : Object, typeof (_d = typeof auth_types_1.TSession !== "undefined" && auth_types_1.TSession) === "function" ? _d : Object]),
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: dto_1.SignInInput }),
    ...
    __param(1, (0, common_1.Session)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_f = typeof express_1.Request !== "undefined" && express_1.Request) === "function" ? _f : Object, typeof (_g = typeof auth_types_1.TSession !== "undefined" && auth_types_1.TSession) === "function" ? _g : Object]),
    __metadata("design:returntype", typeof (_h = typeof Promise !== "undefined" && Promise) === "function" ? _h : Object)
], AuthController.prototype, "signIn", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Sign out current user',
        description: 'Destroys the current user session and signs out the authenticated user. ' +
    ...
    (0, common_1.UseGuards)(guards_2.AuthenticatedGuard),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_1.Get)('sign-out'),
    __param(0, (0, common_1.Session)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_j = typeof auth_types_1.TSession !== "undefined" && auth_types_1.TSession) === "function" ? _j : Object]),
...
__decorate([
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Starts the GitHub OAuth2 authentication flow. ' +
    ...
    (0, common_1.UseGuards)(guards_1.GithubOAuthGuard),
    (0, common_1.Get)('sign-in/github'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "signInGithub", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'GitHub OAuth2 callback handler',
        description: 'Handles the callback from GitHub OAuth2 authentication. ' +
...
__decorate([
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Verifies the 2FA code and completes the sign-in process. ' +
    ...
    __param(1, (0, common_1.Session)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_r = typeof dto_1.Verify2FAInput !== "undefined" && dto_1.Verify2FAInput) === "function" ? _r : Object, typeof (_s = typeof auth_types_1.TSession !== "undefined" && auth_types_1.TSession) === "function" ? _s : Object]),
...
exports.AuthController = AuthController = AuthController_1 = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof auth_service_1.AuthService !== "undefined" && auth_service_1.AuthService) === "function" ? _a : Object, typeof (_b = typeof config_2.ConfigService !== "undefined" && config_2.ConfigService) === "function" ? _b : Object])
], AuthController);
...
const config_1 = __webpack_require__(/*! @/shared/config */ "./src/shared/config/index.ts");
function getCallbackUrl(type, config) {
    return `${config.get(config_1.Env.BASE_URL)}/api/auth/callback/${type}`;
}
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            serializers_1.SessionSerializer,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.localStrategyPayloadSchema = void 0;
const zod_1 = __webpack_require__(/*! zod */ "zod");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
exports.localStrategyPayloadSchema = zod_1.z.object({
    email: zod_1.z.email('Invalid email address'),
    password: zod_1.z
        .string()
        .min(8, 'Password must be at least 8 characters long')
        .refine((val) => (0, class_validator_1.isStrongPassword)(val)),
});
...
const hashing_1 = __webpack_require__(/*! @app/hashing */ "./libs/hashing/src/index.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const two_factor_service_1 = __webpack_require__(/*! ./two-factor/two-factor.service */ "./src/auth/two-factor/two-factor.service.ts");
let AuthService = AuthService_1 = class AuthService {
    ...
    constructor(usersRepository, hashingService, twoFactorService) {
    ...
    async oauthSignIn(dto) {
        if (!dto) {
            throw new common_1.BadRequestException('Invalid OAuth2 data');
        }
    ...
    async signIn(dto) {
        ...
        if (user.lockedUntil && user.lockedUntil > new Date()) {
            ...
            throw new common_1.ForbiddenException('Too many failed attempts. Please try again later.');
        }
        if (!user.hash) {
            throw new common_1.BadRequestException('Invalid email or password');
        }
    ...
    async handleFailedLogin(userId, email) {
        ...
        if (shouldLock) {
            ...
            this.logger.warn(`Failed login attempt ${attempts}/${this.MAX_FAILED_ATTEMPTS}. User ID: ${userId}, Email: ${email}`);
        }
    }
    async verify2FA(userId, method, code) {
        const methodForService = method === 'backup_code' ? 'backup' : method;
        const isValid = await this.twoFactorService.verify2FA(userId, code, methodForService);
        if (!isValid) {
...
exports.AuthService = AuthService = AuthService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof users_repository_1.UsersRepository !== "undefined" && users_repository_1.UsersRepository) === "function" ? _a : Object, typeof (_b = typeof hashing_1.HashingService !== "undefined" && hashing_1.HashingService) === "function" ? _b : Object, typeof (_c = typeof two_factor_service_1.TwoFactorService !== "undefined" && two_factor_service_1.TwoFactorService) === "function" ? _c : Object])
], AuthService);
...
__exportStar(__webpack_require__(/*! ./verify-2fa.dto */ "./src/auth/dto/verify-2fa.dto.ts"), exports);
...
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
const auth_constants_1 = __webpack_require__(/*! @/auth/auth.constants */ "./src/auth/auth.constants.ts");
...
__decorate([
    ...
    (0, class_validator_1.IsStrongPassword)(auth_constants_1.PASSWORD_CONFIG, {
...
__decorate([
    ...
    (0, decorators_1.Trim)(),
    (0, class_validator_1.Matches)(constants_1.REGEX_PATTERNS.USERNAME, {
        message: 'Username can only contain letters, numbers, and underscores',
    }),
    (0, decorators_1.IsRequiredString)(),
    __metadata("design:type", String)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Verify2FAInput = exports.TwoFactorMethod = void 0;
const transformer_decorators_1 = __webpack_require__(/*! @/shared/decorators/transformer.decorators */ "./src/shared/decorators/transformer.decorators.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
var TwoFactorMethod;
...
exports.Verify2FAInput = Verify2FAInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_1.IsEnum)(TwoFactorMethod),
    __metadata("design:type", String)
], Verify2FAInput.prototype, "method", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'The 2FA code (6 digits for TOTP/SMS, 8 characters for backup code)',
        example: '123456',
    }),
    (0, transformer_decorators_1.Trim)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.Matches)(/^[0-9A-Za-z]{6,8}$/, {
        message: 'Code must be 6-8 alphanumeric characters',
    }),
    __metadata("design:type", String)
], Verify2FAInput.prototype, "code", void 0);


/***/ }),

/***/ "./src/auth/email-verification/dto/index.ts":
/*!**************************************************!*\
  !*** ./src/auth/email-verification/dto/index.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./verify-email.dto */ "./src/auth/email-verification/dto/verify-email.dto.ts"), exports);


/***/ }),

/***/ "./src/auth/email-verification/dto/verify-email.dto.ts":
/*!*************************************************************!*\
  !*** ./src/auth/email-verification/dto/verify-email.dto.ts ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
__decorate([
    ...
    (0, decorators_1.IsRequiredString)(6, 6),
    __metadata("design:type", String)
...
let EmailVerificationController = class EmailVerificationController {
    ...
    async verifyEmail(dto, user, session) {
        await this.emailVerificationService.verifyEmail(dto, user);
        await (0, utils_1.updateSession)(session, { passport: { verified: true } });
...
__decorate([
    ...
    (0, swagger_1.ApiBadRequestResponse)({
        description: 'Email already verified | Too many resend attempts | Please wait before requesting a new code | Failed to send email',
    }),
    (0, swagger_1.ApiTooManyRequestsResponse)({
        description: 'Too many requests - Rate limit exceeded',
    }),
...
__decorate([
    (0, swagger_1.ApiOperation)({
        ...
        description: "Verifies the authenticated user's email address using the 6-digit code sent to their email. " +
    ...
    (0, swagger_1.ApiBody)({ type: dto_1.VerifyEmailInput }),
    (0, swagger_1.ApiOkResponse)({
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], EmailVerificationController.prototype, "cleanupExpiredCodes", null);
exports.EmailVerificationController = EmailVerificationController = __decorate([
    ...
    (0, common_1.UseGuards)(throttler_1.ThrottlerGuard, guards_1.AuthenticatedGuard),
    (0, common_1.Controller)('/auth/verification'),
    __metadata("design:paramtypes", [typeof (_a = typeof email_verification_service_1.EmailVerificationService !== "undefined" && email_verification_service_1.EmailVerificationService) === "function" ? _a : Object])
], EmailVerificationController);


/***/ }),

/***/ "./src/auth/email-verification/email-verification.module.ts":
/*!******************************************************************!*\
  !*** ./src/auth/email-verification/email-verification.module.ts ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./src/auth/email-verification/email-verification.service.ts":
/*!*******************************************************************!*\
  !*** ./src/auth/email-verification/email-verification.service.ts ***!
  \*******************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let EmailVerificationService = EmailVerificationService_1 = class EmailVerificationService {
    ...
    CODE_LENGTH = 6;
    CODE_EXPIRATION_MS = 15 * 60 * 1000;
    RESEND_COOLDOWN_MS = 60_000;
    MAX_RESEND_ATTEMPTS = 5;
    constructor(verificationCodeRepository, usersRepository, mailerService, hashingService) {
    ...
    async sendVerificationCode(user) {
        ...
        if (existingCode) {
            if (existingCode.resendCount >= this.MAX_RESEND_ATTEMPTS) {
                ...
                throw new common_1.BadRequestException('Maximum resend attempts reached. Please try again later.');
            }
        ...
        try {
            await this.mailerService.sendEmailVerification(user.email, user.firstName || user.username, plainCode, Math.floor(this.CODE_EXPIRATION_MS / 60000));
        }
        catch (error) {
    ...
    async verifyEmail(dto, user) {
        ...
        if (!code) {
            throw new common_1.BadRequestException('No valid verification code found. Please request a new one.');
        }
...
exports.EmailVerificationService = EmailVerificationService = EmailVerificationService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof verification_code_repository_1.VerificationCodeRepository !== "undefined" && verification_code_repository_1.VerificationCodeRepository) === "function" ? _a : Object, typeof (_b = typeof users_repository_1.UsersRepository !== "undefined" && users_repository_1.UsersRepository) === "function" ? _b : Object, typeof (_c = typeof mailer_1.MailerService !== "undefined" && mailer_1.MailerService) === "function" ? _c : Object, typeof (_d = typeof hashing_1.HashingService !== "undefined" && hashing_1.HashingService) === "function" ? _d : Object])
], EmailVerificationService);


/***/ }),

/***/ "./src/auth/email-verification/verification-code.repository.ts":
/*!*********************************************************************!*\
  !*** ./src/auth/email-verification/verification-code.repository.ts ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var GithubOAuthGuard_1;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.GithubOAuthGuard = void 0;
const auth_constants_1 = __webpack_require__(/*! @/auth/auth.constants */ "./src/auth/auth.constants.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const passport_1 = __webpack_require__(/*! @nestjs/passport */ "@nestjs/passport");
let GithubOAuthGuard = GithubOAuthGuard_1 = class GithubOAuthGuard extends (0, passport_1.AuthGuard)(auth_constants_1.STRATEGIES.GITHUB) {
    logger = new common_1.Logger(GithubOAuthGuard_1.name);
    canActivate(context) {
...
exports.GithubOAuthGuard = GithubOAuthGuard = GithubOAuthGuard_1 = __decorate([
    (0, common_1.Injectable)()
], GithubOAuthGuard);
...
var GoogleOAuthGuard_1;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.GoogleOAuthGuard = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const passport_1 = __webpack_require__(/*! @nestjs/passport */ "@nestjs/passport");
const auth_constants_1 = __webpack_require__(/*! @/auth/auth.constants */ "./src/auth/auth.constants.ts");
let GoogleOAuthGuard = GoogleOAuthGuard_1 = class GoogleOAuthGuard extends (0, passport_1.AuthGuard)(auth_constants_1.STRATEGIES.GOOGLE) {
    logger = new common_1.Logger(GoogleOAuthGuard_1.name);
    canActivate(context) {
...
exports.GoogleOAuthGuard = GoogleOAuthGuard = GoogleOAuthGuard_1 = __decorate([
    (0, common_1.Injectable)()
], GoogleOAuthGuard);
...
__exportStar(__webpack_require__(/*! ./local-auth.guard */ "./src/auth/guards/local-auth.guard.ts"), exports);
...
let LocalAuthGuard = class LocalAuthGuard extends (0, passport_1.AuthGuard)(auth_constants_1.STRATEGIES.LOCAL) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./send-reset-password-token.dto */ "./src/auth/password/dto/send-reset-password-token.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./reset-password.dto */ "./src/auth/password/dto/reset-password.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./verify-reset-password-token.dto */ "./src/auth/password/dto/verify-reset-password-token.dto.ts"), exports);
...
const verify_reset_password_token_dto_1 = __webpack_require__(/*! @/auth/password/dto/verify-reset-password-token.dto */ "./src/auth/password/dto/verify-reset-password-token.dto.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
const auth_constants_1 = __webpack_require__(/*! @/auth/auth.constants */ "./src/auth/auth.constants.ts");
class ResetPasswordInput extends verify_reset_password_token_dto_1.VerifyResetPasswordTokenInput {
    password;
}
...
/***/ "./src/auth/password/dto/send-reset-password-token.dto.ts":
/*!****************************************************************!*\
  !*** ./src/auth/password/dto/send-reset-password-token.dto.ts ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SendResetPasswordTokenInput = void 0;
const decorators_1 = __webpack_require__(/*! @/shared/decorators */ "./src/shared/decorators/index.ts");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const verify_reset_password_token_dto_1 = __webpack_require__(/*! @/auth/password/dto/verify-reset-password-token.dto */ "./src/auth/password/dto/verify-reset-password-token.dto.ts");
class SendResetPasswordTokenInput extends verify_reset_password_token_dto_1.VerifyResetPasswordTokenInput {
    email;
}
exports.SendResetPasswordTokenInput = SendResetPasswordTokenInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_1.IsEmail)(undefined, { message: 'Invalid email address' }),
    __metadata("design:type", String)
], SendResetPasswordTokenInput.prototype, "email", void 0);


/***/ }),

/***/ "./src/auth/password/dto/verify-reset-password-token.dto.ts":
/*!******************************************************************!*\
  !*** ./src/auth/password/dto/verify-reset-password-token.dto.ts ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VerifyResetPasswordTokenInput = void 0;
const decorators_1 = __webpack_require__(/*! @/shared/decorators */ "./src/shared/decorators/index.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
class VerifyResetPasswordTokenInput {
    token;
}
exports.VerifyResetPasswordTokenInput = VerifyResetPasswordTokenInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, decorators_1.IsRequiredString)(),
    __metadata("design:type", String)
], VerifyResetPasswordTokenInput.prototype, "token", void 0);
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Send password reset token to user email' }),
    (0, swagger_1.ApiBody)({ type: dto_1.SendResetPasswordTokenInput }),
    (0, swagger_1.ApiCreatedResponse)({
    ...
    (0, swagger_1.ApiTooManyRequestsResponse)({ description: 'Too many requests' }),
    (0, throttler_1.Throttle)({ default: { ttl: 60_000, limit: 3 } }),
    (0, common_1.Post)('send-token'),
    (0, common_1.HttpCode)(common_1.HttpStatus.CREATED),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof dto_1.SendResetPasswordTokenInput !== "undefined" && dto_1.SendResetPasswordTokenInput) === "function" ? _b : Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: dto_1.ResetPasswordInput }),
    (0, swagger_1.ApiOkResponse)({
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Verify if a reset password token is valid' }),
    (0, swagger_1.ApiBody)({ type: dto_1.VerifyResetPasswordTokenInput }),
    (0, swagger_1.ApiOkResponse)({
    ...
    (0, swagger_1.ApiBadRequestResponse)({ description: 'Invalid or expired token' }),
    (0, swagger_1.ApiTooManyRequestsResponse)({ description: 'Too many requests' }),
    (0, throttler_1.Throttle)({ default: { ttl: 60_000, limit: 10 } }),
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof dto_1.VerifyResetPasswordTokenInput !== "undefined" && dto_1.VerifyResetPasswordTokenInput) === "function" ? _d : Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], PasswordController.prototype, "cleanupExpiredTokens", null);
...
let PasswordService = PasswordService_1 = class PasswordService {
    ...
    RESEND_COOLDOWN_MS = 60_000;
    MAX_RESEND_ATTEMPTS = 5;
    constructor(resetPasswordTokenRepository, usersRepository, mailerService, hashingService, config) {
    ...
    async sendResetPasswordToken(dto) {
        ...
        const existingToken = await this.resetPasswordTokenRepository.findByUserId(user.id);
        if (existingToken) {
            const now = Date.now();
            ...
            if (!isExpired && tokenAge < this.RESEND_COOLDOWN_MS) {
                const remainingSeconds = Math.ceil((this.RESEND_COOLDOWN_MS - tokenAge) / 1000);
                throw new common_1.BadRequestException(`Please wait ${remainingSeconds} seconds before requesting a new token`);
            }
            if (existingToken.resendCount >= this.MAX_RESEND_ATTEMPTS) {
                throw new common_1.BadRequestException('Maximum resend attempts reached. Please try again later');
            }
            if (!isExpired) {
                await this.resetPasswordTokenRepository.incrementResendCount(existingToken.id);
                const clientUrl = this.config.get(config_1.Env.FRONTEND_URL);
    ...
    async verifyToken(dto) {
        ...
        const token = await this.resetPasswordTokenRepository.findByToken(tokenHash);
    ...
    async cleanupExpiredTokens() {
        const result = await this.resetPasswordTokenRepository.deleteExpiredTokens();
        this.logger.log(`Cleaned up ${result.count} expired reset tokens`);
        return result.count;
    }
    generateToken() {
        return (0, node_crypto_1.randomBytes)(this.TOKEN_LENGTH).toString('hex');
    }
    async simulateDelay() {
...
exports.PasswordService = PasswordService = PasswordService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof reset_password_token_repository_1.ResetPasswordTokenRepository !== "undefined" && reset_password_token_repository_1.ResetPasswordTokenRepository) === "function" ? _a : Object, typeof (_b = typeof users_repository_1.UsersRepository !== "undefined" && users_repository_1.UsersRepository) === "function" ? _b : Object, typeof (_c = typeof mailer_1.MailerService !== "undefined" && mailer_1.MailerService) === "function" ? _c : Object, typeof (_d = typeof hashing_1.HashingService !== "undefined" && hashing_1.HashingService) === "function" ? _d : Object, typeof (_e = typeof config_2.ConfigService !== "undefined" && config_2.ConfigService) === "function" ? _e : Object])
], PasswordService);


/***/ }),

/***/ "./src/auth/password/reset-password-token.repository.ts":
/*!**************************************************************!*\
  !*** ./src/auth/password/reset-password-token.repository.ts ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const prisma_1 = __webpack_require__(/*! @app/prisma */ "./libs/prisma/src/index.ts");
let ResetPasswordTokenRepository = class ResetPasswordTokenRepository {
    db;
    constructor(db) {
        this.db = db;
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./session.serializer */ "./src/auth/serializers/session.serializer.ts"), exports);


/***/ }),

/***/ "./src/auth/serializers/session.serializer.ts":
/*!****************************************************!*\
  !*** ./src/auth/serializers/session.serializer.ts ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const auth_helpers_1 = __webpack_require__(/*! @/auth/auth.helpers */ "./src/auth/auth.helpers.ts");
const config_1 = __webpack_require__(/*! @/shared/config */ "./src/shared/config/index.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const config_2 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
const passport_1 = __webpack_require__(/*! @nestjs/passport */ "@nestjs/passport");
...
let GithubStrategy = GithubStrategy_1 = class GithubStrategy extends (0, passport_1.PassportStrategy)(passport_github2_1.Strategy, 'github') {
    ...
    constructor(config) {
        super({
            clientID: config.get(config_1.Env.GITHUB_CLIENT_ID),
            clientSecret: config.get(config_1.Env.GITHUB_CLIENT_SECRET),
            callbackURL: (0, auth_helpers_1.getCallbackUrl)('github', config),
            scope: ['user:email'],
        });
        this.config = config;
    }
    validate(at, rt, profile, done) {
        ...
        if (!emails?.length || !photos?.length) {
            ...
            return done(new common_1.UnauthorizedException('Incomplete GitHub profile'), null);
        }
        const user = {
...
let GoogleStrategy = GoogleStrategy_1 = class GoogleStrategy extends (0, passport_1.PassportStrategy)(passport_google_oauth20_1.Strategy, 'google') {
    ...
    constructor(config) {
        super({
            clientID: config.get(config_2.Env.GOOGLE_CLIENT_ID),
            clientSecret: config.get(config_2.Env.GOOGLE_CLIENT_SECRET),
            scope: ['email', 'profile'],
            callbackURL: (0, auth_helpers_1.getCallbackUrl)('google', config),
        });
        this.config = config;
    }
    validate(at, rt, profile, done) {
        ...
        if (!emails?.length || !photos?.length) {
            ...
            return done(new common_1.UnauthorizedException('Incomplete Google profile'), null);
        }
        const user = {
            email: emails[0].value,
            avatar: {
...
const auth_constants_1 = __webpack_require__(/*! @/auth/auth.constants */ "./src/auth/auth.constants.ts");
const auth_schemas_1 = __webpack_require__(/*! @/auth/auth.schemas */ "./src/auth/auth.schemas.ts");
const auth_service_1 = __webpack_require__(/*! @/auth/auth.service */ "./src/auth/auth.service.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const passport_1 = __webpack_require__(/*! @nestjs/passport */ "@nestjs/passport");
const passport_local_1 = __webpack_require__(/*! passport-local */ "passport-local");
let LocalStrategy = LocalStrategy_1 = class LocalStrategy extends (0, passport_1.PassportStrategy)(passport_local_1.Strategy, auth_constants_1.STRATEGIES.LOCAL) {
    authService;
    ...
    async validate(email, password) {
        ...
        try {
            auth_schemas_1.localStrategyPayloadSchema.parse({ email, password });
        }
        catch {
...
/***/ "./src/auth/two-factor/dto/disable-sms.dto.ts":
/*!****************************************************!*\
  !*** ./src/auth/two-factor/dto/disable-sms.dto.ts ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DisableSmsInput = void 0;
const decorators_1 = __webpack_require__(/*! @/shared/decorators */ "./src/shared/decorators/index.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
class DisableSmsInput {
    code;
}
exports.DisableSmsInput = DisableSmsInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.Length)(6, 6, { message: 'SMS code must be exactly 6 digits' }),
    __metadata("design:type", String)
], DisableSmsInput.prototype, "code", void 0);


/***/ }),

/***/ "./src/auth/two-factor/dto/disable-totp.dto.ts":
/*!*****************************************************!*\
  !*** ./src/auth/two-factor/dto/disable-totp.dto.ts ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DisableTotpInput = void 0;
const decorators_1 = __webpack_require__(/*! @/shared/decorators */ "./src/shared/decorators/index.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
...
exports.DisableTotpInput = DisableTotpInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], DisableTotpInput.prototype, "code", void 0);


/***/ }),

/***/ "./src/auth/two-factor/dto/index.ts":
/*!******************************************!*\
  !*** ./src/auth/two-factor/dto/index.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./disable-sms.dto */ "./src/auth/two-factor/dto/disable-sms.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./disable-totp.dto */ "./src/auth/two-factor/dto/disable-totp.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./regenerate-backup-codes.dto */ "./src/auth/two-factor/dto/regenerate-backup-codes.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./setup-sms.dto */ "./src/auth/two-factor/dto/setup-sms.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./verify-backup-code.dto */ "./src/auth/two-factor/dto/verify-backup-code.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./verify-sms.dto */ "./src/auth/two-factor/dto/verify-sms.dto.ts"), exports);
__exportStar(__webpack_require__(/*! ./verify-totp.dto */ "./src/auth/two-factor/dto/verify-totp.dto.ts"), exports);


/***/ }),

/***/ "./src/auth/two-factor/dto/regenerate-backup-codes.dto.ts":
/*!****************************************************************!*\
  !*** ./src/auth/two-factor/dto/regenerate-backup-codes.dto.ts ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RegenerateBackupCodesInput = void 0;
const decorators_1 = __webpack_require__(/*! @/shared/decorators */ "./src/shared/decorators/index.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
...
exports.RegenerateBackupCodesInput = RegenerateBackupCodesInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    __metadata("design:type", String)
], RegenerateBackupCodesInput.prototype, "token", void 0);


/***/ }),

/***/ "./src/auth/two-factor/dto/setup-sms.dto.ts":
/*!**************************************************!*\
  !*** ./src/auth/two-factor/dto/setup-sms.dto.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.SetupSmsInput = SetupSmsInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    __metadata("design:type", String)
], SetupSmsInput.prototype, "phoneNumber", void 0);


/***/ }),

/***/ "./src/auth/two-factor/dto/verify-backup-code.dto.ts":
/*!***********************************************************!*\
  !*** ./src/auth/two-factor/dto/verify-backup-code.dto.ts ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VerifyBackupCodeInput = void 0;
const decorators_1 = __webpack_require__(/*! @/shared/decorators */ "./src/shared/decorators/index.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
class VerifyBackupCodeInput {
    code;
}
exports.VerifyBackupCodeInput = VerifyBackupCodeInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    __metadata("design:type", String)
], VerifyBackupCodeInput.prototype, "code", void 0);


/***/ }),

/***/ "./src/auth/two-factor/dto/verify-sms.dto.ts":
/*!***************************************************!*\
  !*** ./src/auth/two-factor/dto/verify-sms.dto.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VerifySmsInput = void 0;
const decorators_1 = __webpack_require__(/*! @/shared/decorators */ "./src/shared/decorators/index.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
class VerifySmsInput {
    code;
}
exports.VerifySmsInput = VerifySmsInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_1.Length)(6, 6, { message: 'SMS code must be exactly 6 digits' }),
    __metadata("design:type", String)
], VerifySmsInput.prototype, "code", void 0);


/***/ }),

/***/ "./src/auth/two-factor/dto/verify-totp.dto.ts":
/*!****************************************************!*\
  !*** ./src/auth/two-factor/dto/verify-totp.dto.ts ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VerifyTotpInput = void 0;
const decorators_1 = __webpack_require__(/*! @/shared/decorators */ "./src/shared/decorators/index.ts");
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
class VerifyTotpInput {
    token;
}
exports.VerifyTotpInput = VerifyTotpInput;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_1.Length)(6, 6, { message: 'TOTP code must be exactly 6 digits' }),
    __metadata("design:type", String)
], VerifyTotpInput.prototype, "token", void 0);


/***/ }),

/***/ "./src/auth/two-factor/totp.service.ts":
/*!*********************************************!*\
  !*** ./src/auth/two-factor/totp.service.ts ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let TotpService = class TotpService {
    ...
    generateSecret(email) {
        ...
        const appName = this.config.get(config_1.Env.APP_NAME);
...
const swagger_1 = __webpack_require__(/*! @nestjs/swagger */ "@nestjs/swagger");
const throttler_1 = __webpack_require__(/*! @nestjs/throttler */ "@nestjs/throttler");
const dto_1 = __webpack_require__(/*! ./dto */ "./src/auth/two-factor/dto/index.ts");
const two_factor_service_1 = __webpack_require__(/*! ./two-factor.service */ "./src/auth/two-factor/two-factor.service.ts");
let TwoFactorController = class TwoFactorController {
    ...
    async verifyAndEnableTotp(userId, dto) {
...
__decorate([
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Returns the current status of all two-factor authentication methods enabled for the user',
    }),
    (0, swagger_1.ApiOkResponse)({
...
__decorate([
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Generates a secret and QR code for setting up TOTP authentication with apps like Google Authenticator or Authy. ' +
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TwoFactorController.prototype, "setupTotp", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Verify and enable TOTP',
        description: 'Verifies the TOTP token from the authenticator app and enables TOTP authentication. ' +
    ...
    (0, swagger_1.ApiBadRequestResponse)({ description: 'TOTP not set up or invalid token' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'User not authenticated' }),
    (0, swagger_1.ApiTooManyRequestsResponse)({ description: 'Too many requests' }),
    (0, throttler_1.Throttle)({ default: { ttl: 60_000, limit: 10 } }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_b = typeof dto_1.VerifyTotpInput !== "undefined" && dto_1.VerifyTotpInput) === "function" ? _b : Object]),
    __metadata("design:returntype", Promise)
], TwoFactorController.prototype, "verifyAndEnableTotp", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Disable TOTP authentication',
        description: 'Disables TOTP authentication for the user. Requires a valid TOTP token or backup code for verification.',
    }),
    (0, swagger_1.ApiOkResponse)({
    ...
    (0, swagger_1.ApiBadRequestResponse)({ description: 'Invalid code' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'User not authenticated' }),
    (0, swagger_1.ApiTooManyRequestsResponse)({ description: 'Too many requests' }),
    (0, throttler_1.Throttle)({ default: { ttl: 60_000, limit: 5 } }),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_1.Delete)('totp'),
    __param(0, (0, decorators_1.CurrentUser)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_c = typeof dto_1.DisableTotpInput !== "undefined" && dto_1.DisableTotpInput) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
], TwoFactorController.prototype, "disableTotp", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Setup SMS two-factor authentication',
        description: 'Initiates SMS two-factor authentication by sending a verification code to the provided phone number. ' +
    ...
    (0, swagger_1.ApiBadRequestResponse)({ description: 'Invalid phone number format' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'User not authenticated' }),
    (0, swagger_1.ApiTooManyRequestsResponse)({ description: 'Too many requests' }),
    (0, throttler_1.Throttle)({ default: { ttl: 60_000, limit: 3 } }),
    (0, common_1.Post)('sms/setup'),
    __param(0, (0, decorators_1.CurrentUser)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_d = typeof dto_1.SetupSmsInput !== "undefined" && dto_1.SetupSmsInput) === "function" ? _d : Object]),
    __metadata("design:returntype", Promise)
], TwoFactorController.prototype, "setupSms", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Verify and enable SMS authentication',
        description: 'Verifies the SMS code and enables SMS two-factor authentication. ' +
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_e = typeof dto_1.VerifySmsInput !== "undefined" && dto_1.VerifySmsInput) === "function" ? _e : Object]),
    __metadata("design:returntype", Promise)
], TwoFactorController.prototype, "verifyAndEnableSms", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Disable SMS authentication',
        description: 'Disables SMS two-factor authentication for the user. Requires a valid SMS code for verification.',
    }),
    (0, swagger_1.ApiOkResponse)({
    ...
    (0, swagger_1.ApiBadRequestResponse)({ description: 'Invalid SMS code' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'User not authenticated' }),
    (0, swagger_1.ApiTooManyRequestsResponse)({ description: 'Too many requests' }),
    (0, throttler_1.Throttle)({ default: { ttl: 60_000, limit: 5 } }),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_1.Delete)('sms'),
    __param(0, (0, decorators_1.CurrentUser)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_f = typeof dto_1.DisableSmsInput !== "undefined" && dto_1.DisableSmsInput) === "function" ? _f : Object]),
    __metadata("design:returntype", Promise)
], TwoFactorController.prototype, "disableSms", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Resend SMS verification code',
        description: 'Resends the SMS verification code to the phone number on file. Rate limited to prevent abuse.',
    }),
    (0, swagger_1.ApiOkResponse)({
    ...
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'User not authenticated' }),
    (0, swagger_1.ApiTooManyRequestsResponse)({ description: 'Too many requests' }),
    (0, throttler_1.Throttle)({ default: { ttl: 60_000, limit: 2 } }),
    (0, common_1.Post)('sms/resend'),
    __param(0, (0, decorators_1.CurrentUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TwoFactorController.prototype, "resendSmsCode", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Verify backup code',
        description: 'Verifies a backup code. This is typically used during login when the primary 2FA method is unavailable. ' +
    ...
    (0, swagger_1.ApiTooManyRequestsResponse)({ description: 'Too many requests' }),
    (0, throttler_1.Throttle)({ default: { ttl: 60_000, limit: 10 } }),
    (0, common_1.Post)('backup-codes/verify'),
    __param(0, (0, decorators_1.CurrentUser)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_g = typeof dto_1.VerifyBackupCodeInput !== "undefined" && dto_1.VerifyBackupCodeInput) === "function" ? _g : Object]),
    __metadata("design:returntype", Promise)
], TwoFactorController.prototype, "verifyBackupCode", null);
__decorate([
    (0, swagger_1.ApiOperation)({
        summary: 'Regenerate backup codes',
        description: 'Generates new backup codes and invalidates all previous ones. ' +
    ...
    (0, swagger_1.ApiBadRequestResponse)({ description: 'TOTP not enabled' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'User not authenticated' }),
    (0, swagger_1.ApiTooManyRequestsResponse)({ description: 'Too many requests' }),
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_h = typeof dto_1.RegenerateBackupCodesInput !== "undefined" && dto_1.RegenerateBackupCodesInput) === "function" ? _h : Object]),
    __metadata("design:returntype", Promise)
...
exports.TwoFactorController = TwoFactorController = __decorate([
    ...
    (0, common_1.UseGuards)(guards_1.AuthenticatedGuard, throttler_1.ThrottlerGuard),
    (0, common_1.Controller)('auth/two-factor'),
...
const totp_service_1 = __webpack_require__(/*! @/auth/two-factor/totp.service */ "./src/auth/two-factor/totp.service.ts");
const two_factor_controller_1 = __webpack_require__(/*! @/auth/two-factor/two-factor.controller */ "./src/auth/two-factor/two-factor.controller.ts");
...
/***/ "./src/auth/two-factor/two-factor.repository.ts":
/*!******************************************************!*\
  !*** ./src/auth/two-factor/two-factor.repository.ts ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const prisma_1 = __webpack_require__(/*! @app/prisma */ "./libs/prisma/src/index.ts");
let TwoFactorRepository = class TwoFactorRepository {
    db;
    constructor(db) {
        this.db = db;
    }
...
exports.TwoFactorRepository = TwoFactorRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof prisma_1.PrismaService !== "undefined" && prisma_1.PrismaService) === "function" ? _a : Object])
], TwoFactorRepository);
...
let TwoFactorService = TwoFactorService_1 = class TwoFactorService {
    ...
    async verifyAndEnableTotp(userId, token) {
        ...
        const isValid = this.totpService.verifyToken(twoFactorAuth.totpSecret, token);
        if (!isValid) {
        ...
        const hashedBackupCodes = await Promise.all(backupCodes.map((code) => this.hashingService.hash(code)));
    ...
    async disableTotp(userId, code) {
        ...
        if (!twoFactorAuth?.totpEnabled) {
            throw new common_1.BadRequestException('TOTP not enabled');
        }
        let isValid = false;
        ...
        if (!isValid && code.length === 8) {
            isValid = await this.verifyBackupCodeInternal(userId, code, twoFactorAuth.backupCodes);
        }
        if (!isValid) {
    ...
    async setupSms(userId, phoneNumber) {
        ...
        try {
            ...
            throw new common_1.BadRequestException('Failed to send SMS code');
        }
    ...
    async disableSms(userId, code) {
        const twoFactorAuth = await this.twoFactorRepository.findByUserId(userId);
        if (!twoFactorAuth?.smsEnabled) {
            throw new common_1.BadRequestException('SMS not enabled');
        }
        if (!twoFactorAuth.smsCode || !twoFactorAuth.smsCodeExpiresAt) {
            ...
            throw new common_1.BadRequestException('Verification code sent. Please provide the code to disable SMS.');
        }
        if (new Date() > twoFactorAuth.smsCodeExpiresAt) {
            throw new common_1.BadRequestException('SMS code has expired');
        }
    ...
    async resendSmsCode(userId) {
        const twoFactorAuth = await this.twoFactorRepository.findByUserId(userId);
        if (!twoFactorAuth?.phoneNumber) {
            throw new common_1.BadRequestException('Phone number not set up');
        }
        const code = Math.floor(100000 + Math.random() * 900000).toString();
        try {
    ...
    async verifyBackupCode(userId, code) {
        ...
        const isValid = await this.verifyBackupCodeInternal(userId, code, twoFactorAuth.backupCodes);
        if (!isValid) {
    ...
    async verifyBackupCodeInternal(userId, code, backupCodes) {
    ...
    async regenerateBackupCodes(userId, totpToken) {
        ...
        const isValid = this.totpService.verifyToken(twoFactorAuth.totpSecret, totpToken);
        if (!isValid) {
            this.logger.warn(`Invalid TOTP token for backup code regeneration: ${userId}`);
            throw new common_1.UnauthorizedException('Invalid TOTP token');
        }
        const backupCodes = this.totpService.generateBackupCodes();
        const hashedBackupCodes = await Promise.all(backupCodes.map((code) => this.hashingService.hash(code)));
    ...
    async verify2FA(userId, code, method) {
        const twoFactorAuth = await this.twoFactorRepository.findByUserId(userId);
        if (!twoFactorAuth) {
            return false;
        }
        try {
            switch (method) {
                ...
                case 'backup':
                    ...
                    return await this.verifyBackupCodeInternal(userId, code, twoFactorAuth.backupCodes);
                default:
                    return false;
            }
        }
    ...
    async send2FACode(userId) {
        ...
        if (!twoFactorAuth?.smsEnabled || !twoFactorAuth.phoneNumber) {
            throw new common_1.BadRequestException('SMS 2FA not enabled');
        }
        const code = Math.floor(100000 + Math.random() * 900000).toString();
        const expiresAt = new Date(Date.now() + this.SMS_EXPIRATION_TIME);
        try {
...
const Sentry = __webpack_require__(/*! @sentry/nestjs */ "@sentry/nestjs");
const { nodeProfilingIntegration } = __webpack_require__(/*! @sentry/profiling-node */ "@sentry/profiling-node");
...
exports.envSchema = zod_1.z.object({
    ...
    APP_NAME: zod_1.z.string().min(1).default('Prisma Next.js Starter'),
    BASE_URL: zod_1.z.url(),
    FRONTEND_URL: zod_1.z.url(),
    DATABASE_URL: zod_1.z.url().min(1),
    ...
    MAIL_PASSWORD: zod_1.z.string().min(1),
...
const literalKeys = exports.envSchema.keyof().options;
exports.Env = toLiteralMap(literalKeys);


/***/ }),

/***/ "./src/shared/config/helmet.config.ts":
/*!********************************************!*\
  !*** ./src/shared/config/helmet.config.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
function getSessionConfig(config, redis) {
    const isProduction = config.get(env_config_1.Env.NODE_ENV) === 'production';
    return {
        secret: config.get(env_config_1.Env.SESSION_SECRET),
        resave: false,
        saveUninitialized: false,
        cookie: {
            maxAge: constants_1.SESSION_MAX_AGE,
            secure: isProduction,
            httpOnly: true,
            sameSite: 'strict',
        },
        name: constants_1.SESSION_COOKIE_NAME,
        store: new connect_redis_1.RedisStore({
            client: redis,
            prefix: 'sess:',
            ttl: constants_1.SESSION_MAX_AGE / 1000,
        }),
        rolling: true,
    };
}
...
/***/ "./src/shared/constants/csrf.constants.ts":
/*!************************************************!*\
  !*** ./src/shared/constants/csrf.constants.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CSRF_COOKIE_MAX_AGE = exports.CSRF_COOKIE_NAME = void 0;
exports.CSRF_COOKIE_NAME = 'csrf-token';
exports.CSRF_COOKIE_MAX_AGE = 60 * 60 * 24 * 7;
...
/***/ "./src/shared/constants/regexp.constants.ts":
/*!**************************************************!*\
  !*** ./src/shared/constants/regexp.constants.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/shared/decorators/transformer.decorators.ts":
/*!*********************************************************!*\
  !*** ./src/shared/decorators/transformer.decorators.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
function Trim() {
    return (0, common_1.applyDecorators)((0, class_transformer_1.Transform)(({ value }) => {
        if (typeof value !== 'string') {
            throw new Error('Trim decorator can only be applied to string properties');
        }
        return value.trim();
    }));
}
function ToLowerCase() {
    return (0, common_1.applyDecorators)((0, class_transformer_1.Transform)(({ value }) => {
        if (typeof value !== 'string') {
            throw new Error('ToLowerCase decorator can only be applied to string properties');
        }
...
/***/ "./src/shared/guards/authenticated.guard.ts":
/*!**************************************************!*\
  !*** ./src/shared/guards/authenticated.guard.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./logging.interceptor */ "./src/shared/interceptors/logging.interceptor.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./security-headers.middleware */ "./src/shared/middlewares/security-headers.middleware.ts"), exports);


/***/ }),

/***/ "./src/shared/middlewares/security-headers.middleware.ts":
/*!***************************************************************!*\
  !*** ./src/shared/middlewares/security-headers.middleware.ts ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./sanitization.pipe */ "./src/shared/pipes/sanitization.pipe.ts"), exports);
...
let SanitizationPipe = class SanitizationPipe {
    transform(value, metadata) {
        ...
        if (typeof value === 'string') {
            return utils_1.SanitizationUtil.sanitizeInput(value);
        }
        if (Array.isArray(value)) {
            return utils_1.SanitizationUtil.sanitizeArray(value);
        }
        if (typeof value === 'object') {
            return utils_1.SanitizationUtil.sanitizeObject(value);
        }
        return value;
    }
};
...
/***/ "./src/shared/utils/sanitization.utils.ts":
/*!************************************************!*\
  !*** ./src/shared/utils/sanitization.utils.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const xss_1 = __webpack_require__(/*! xss */ "xss");
...
let UsersRepository = class UsersRepository {
    ...
    async updateFailedLoginAttempts(userId, data) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./instrument */ "./src/instrument.ts");
const config_1 = __webpack_require__(/*! @/shared/config */ "./src/shared/config/index.ts");
const pipes_1 = __webpack_require__(/*! @/shared/pipes */ "./src/shared/pipes/index.ts");
const logger_1 = __webpack_require__(/*! @app/logger */ "./libs/logger/src/index.ts");
const redis_1 = __webpack_require__(/*! @app/redis */ "./libs/redis/src/index.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const config_2 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
...
async function bootstrap() {
    ...
    const config = app.get(config_2.ConfigService);
    const redis = app.get(redis_1.RedisService);
    const PORT = config.get(config_1.Env.PORT) || 8080;
    app.setGlobalPrefix('api');
    const swaggerConfig = new swagger_1.DocumentBuilder()
        .setTitle(config.get(config_1.Env.APP_NAME))
        .setVersion('1.0')
        .addGlobalResponse({
        status: 500,
